#!/usr/bin/env python
#
# classproperty documentation build configuration file, created by sphinx-quickstart.
#
...
version = classproperty.__version__
# The full version, including alpha/beta/rc tags.
release = classproperty.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(classproperty.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "classproperty/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/classproperty/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "classpropertydoc"
